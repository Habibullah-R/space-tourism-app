...
const getData = (data)=>{
  ...
  return (
    <>
    <div className={toggle === 1 ? 'flex items-center justify-between w-full mt-8' : 'hidden'}>
      <div className="text-white md:h-[445px] md:w-[445px]">
      ...
      <div className=" flex flex-col md:w-[445px] ">
        ...
        <h1>MOON</h1>
        <p className='text-[#D0D6F9] leading-7'>See our planet as you've never seen it before. A perfect relaxing trip away to help 
...
<div className={toggle === 2 ? 'flex items-center justify-between w-full mt-8' : 'hidden'}>
      <div className="text-white md:h-[445px] md:w-[445px]">
      ...
      <div className=" flex flex-col md:w-[445px] ">
        ...
        <h1>MARS</h1>
        <p className='text-[#D0D6F9] leading-7 md:w-[330px]'>Don't forget to pack your hiking boots. You'll need them to tackle Olympus Mons, 
  ...
  <div>
    ...
    <div className={toggle === 3 ? 'flex items-center justify-between w-full mt-8' : 'hidden'}>
      <div className="text-white md:h-[445px] md:w-[445px]">
      ...
      <div className=" flex flex-col md:w-[445px] ">
        ...
        <h1>EUROPA</h1>
        <p className='text-[#D0D6F9] md:w-[400px] leading-7'>The smallest of the four Galilean moons orbiting Jupiter, Europa is a 
  ...
  <div>
    ...
    <div className={toggle === 4 ? 'flex items-center justify-between w-full mt-8' : 'hidden'}>
      <div className="text-white md:h-[445px] md:w-[445px]">
      ...
      <DestinOpt number={toggle === 4 ? '4' : " "} onClick={getData}/>
        <h1>TITAN</h1>
        <p className='text-[#D0D6F9] md:w-[400px] leading-7'>The only moon known to have a dense atmosphere other than Earth, Titan 
